...
INSTRUMENTS: dict[str, Instrument] = {
    "SPX": Instrument("SPX", "^GSPC", "mean_reversion", "15m", risk_group="risk_on"),
    "NDX": Instrument("NDX", "^IXIC", "mean_reversion", "15m", risk_group="risk_on"),
    "BTC": Instrument("BTC", "BTC-USD", "momentum_breakout", "1h", risk_group="risk_on"),
    "GOLD": Instrument("GOLD", "GC=F", "trend_following", "4h", risk_group="commodity"),
    "OIL": Instrument("OIL", "CL=F", "trend_following", "4h", risk_group="commodity"),
}
